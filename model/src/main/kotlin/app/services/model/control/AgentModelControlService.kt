...
class AgentModelControlService(apiClient: AgentModelApiClient) : Service() {
    ...
    suspend fun runModel() = context.runModel()
    suspend fun pauseModel() = context.pauseModel()
    suspend fun resumeModel() = context.resumeModel()
    suspend fun stopModel() = context.stopModel()
