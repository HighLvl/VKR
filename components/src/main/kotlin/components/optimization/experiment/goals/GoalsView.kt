package components.optimization.experiment.goals

import components.view.COLOR_FV_GOOD
import components.view.COLOR_IV_GOOD
import components.view.TableView
...
internal class GoalsView(dataSource: Map<String, Series<*>>, rowTypes: Series<Int>) :
