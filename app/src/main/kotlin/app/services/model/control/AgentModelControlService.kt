...
class AgentModelControlService(modelApi: IPModelAPI, sceneApi: SceneApi, requestDispatcher: RequestDispatcher, requestSender: RequestSender) : Service(), AgentModelControl {
